...
public class BuGabuildingsguidePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "BuGabuildingsguide";
	...
	private BuGabuildingsguidePersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(de.hhn.se.pmt.buildings.model.Standort.class);
		configuration.addAnnotatedClass(de.hhn.se.pmt.buildings.model.Bewertung.class);
		configuration.addAnnotatedClass(de.hhn.se.pmt.buildings.model.BuGaBesucher.class);
		configuration.addAnnotatedClass(de.hhn.se.pmt.buildings.model.Architekt.class);
		configuration.addAnnotatedClass(de.hhn.se.pmt.buildings.model.Gebäude.class);
		configuration.addAnnotatedClass(de.hhn.se.pmt.buildings.model.Merkliste.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new BuGabuildingsguidePersistentManager();
		}
