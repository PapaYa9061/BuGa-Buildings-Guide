...
public class StandortDAOImpl implements de.hhn.se.pmt.buildings.model.dao.StandortDAO {
	...
	public Standort loadStandortByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Standort) session.load(de.hhn.se.pmt.buildings.model.Standort.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Standort getStandortByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Standort) session.get(de.hhn.se.pmt.buildings.model.Standort.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Standort loadStandortByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Standort) session.load(de.hhn.se.pmt.buildings.model.Standort.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public Standort getStandortByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Standort) session.get(de.hhn.se.pmt.buildings.model.Standort.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public List queryStandort(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From de.hhn.se.pmt.buildings.model.Standort as Standort");
		if (condition != null)
	...
	public Standort createStandort() {
		return new de.hhn.se.pmt.buildings.model.Standort();
	}
	
	public boolean save(de.hhn.se.pmt.buildings.model.Standort standort) throws PersistentException {
		try {
			BuGabuildingsguidePersistentManager.instance().saveObject(standort);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete(de.hhn.se.pmt.buildings.model.Standort standort) throws PersistentException {
		try {
			BuGabuildingsguidePersistentManager.instance().deleteObject(standort);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean deleteAndDissociate(de.hhn.se.pmt.buildings.model.Standort standort)throws PersistentException {
		try {
			if (standort.getGebäude() != null) {
				standort.getGebäude().setStandort(null);
			}
	...
	public boolean deleteAndDissociate(de.hhn.se.pmt.buildings.model.Standort standort, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (standort.getGebäude() != null) {
				standort.getGebäude().setStandort(null);
			}
	...
	public boolean refresh(de.hhn.se.pmt.buildings.model.Standort standort) throws PersistentException {
		try {
			BuGabuildingsguidePersistentManager.instance().getSession().refresh(standort);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict(de.hhn.se.pmt.buildings.model.Standort standort) throws PersistentException {
		try {
			BuGabuildingsguidePersistentManager.instance().getSession().evict(standort);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
